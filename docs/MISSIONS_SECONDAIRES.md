...
L’Académie a deux usages distincts : son panneau est le point de lecture de la mission d’accueil d’Aoi ; la Docteure Hana, placée dans la cour d’entraînement, est un donneur de mission secondaire séparé. Elle apparaît uniquement après le rapport et la récompense de la deuxième mission de clan. Le serveur décide du déblocage ; le client ne peut pas le simuler.
