...
**Mise à jour du 14 septembre 2026 — APK 0.12.0/code 12 vérifiée :** l’exécution GitHub Actions **34827049533** a réussi l’import Godot, les **312 assertions**, les quatre scénarios WSS natifs, l’export Android et les contrôles de paquet. La résidence utilise maintenant un hall extérieur ouvert en permanence : il n’y a aucun bouton d’entrée ou de sortie, le joueur traverse automatiquement en avançant ; l’intérieur conserve ses deux niveaux, ses salles utiles, ses portraits encadrés et son balcon orienté vers Konoha. L’artefact téléchargeable est [`idrem-zenkai-android-87`](https://github.com/Zorolefrerot/MATCHLY-PROJECT/actions/runs/34827049533/artifacts/10341080082), **79 884 704 octets**, jusqu’au **21 septembre 2026 à 09:18:52 UTC**. Le site pointe vers cette compilation pour les joueurs acceptés ; il faut encore déclencher le Manual Deploy du service Render pour rendre la nouvelle référence visible en production.
...
`server/android-build.js` pointe maintenant vers l’APK **0.12.0/code 12** vérifiée du village complet avec le hall ouvert de la résidence du Hokage et la traversée automatique sans bouton : ZIP `idrem-zenkai-android-87`, **79 884 704 octets**, expiration **21 septembre 2026 à 09:18:52 UTC**. Le téléchargement reste protégé par l’admission du compte ; la nouvelle référence sera visible en production après le Manual Deploy Render.
