...
`server/android-build.js` pointe maintenant vers l’APK **0.12.0/code 12** vérifiée du village complet avec le hall ouvert de la résidence du Hokage et la traversée automatique sans bouton : ZIP `idrem-zenkai-android-88`, **79 883 769 octets**, expiration **21 septembre 2026 à 09:26:30 UTC**. Le téléchargement reste protégé par l’admission du compte ; la nouvelle référence sera visible en production après le Manual Deploy Render.
