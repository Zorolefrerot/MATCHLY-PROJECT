...
`server/android-build.js` pointe maintenant vers l’APK **0.12.0/code 12** vérifiée du village complet avec le hall ouvert de la résidence du Hokage et l’entrée manuelle par `E` : ZIP `idrem-zenkai-android-87`, **79 884 704 octets**, expiration **21 septembre 2026 à 09:18:52 UTC**. Le téléchargement reste protégé par l’admission du compte ; la nouvelle référence sera visible en production après le Manual Deploy Render.
