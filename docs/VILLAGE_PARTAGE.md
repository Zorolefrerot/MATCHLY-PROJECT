...
**Mise à jour du 13 septembre 2026 — APK 0.12.0/code 12 vérifiée :** l’exécution GitHub Actions **34788167226** a réussi l’import Godot, les **312 assertions**, les quatre scénarios WSS natifs, l’export Android et les contrôles de paquet avec l’entrée stabilisée, la porte principale collée au bâtiment et le balcon orienté vers Konoha. L’artefact téléchargeable est [`idrem-zenkai-android-84`](https://github.com/Zorolefrerot/MATCHLY-PROJECT/actions/runs/34788167226/artifacts/10326823243), **79 878 503 octets**, jusqu’au **20 septembre 2026 à 22:57:36 UTC**. Le site pointe vers cette compilation pour les joueurs acceptés ; il faut encore déclencher le Manual Deploy du service Render pour rendre la nouvelle référence visible en production.
...
`server/android-build.js` pointe maintenant vers l’APK **0.12.0/code 12** vérifiée du village complet avec l’intérieur de la résidence du Hokage : ZIP `idrem-zenkai-android-84`, **79 878 503 octets**, expiration **20 septembre 2026 à 22:57:36 UTC**. Le bouton reste protégé par l’admission du compte ; il sera visible en production après le Manual Deploy Render.
