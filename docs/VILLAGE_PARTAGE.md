...
`server/android-build.js` pointe maintenant vers l’APK **0.12.0/code 12** vérifiée du village complet avec la façade fermée réparée, le sceau bleu de trois secondes et le chargement avant téléportation sans bouton : ZIP `idrem-zenkai-android-88`, **79 883 769 octets**, expiration **21 septembre 2026 à 09:26:30 UTC**. Le téléchargement reste protégé par l’admission du compte ; la nouvelle référence sera visible en production après le Manual Deploy Render.
