...
- [ZIP `idrem-zenkai-android-41` — environ 72 Mo](https://github.com/Zorolefrerot/MATCHLY-PROJECT/actions/runs/34725613010/artifacts/10307567913), jusqu’au **19 septembre 2026 à 23:33 UTC** ; connexion GitHub nécessaire.
- [Exécution verte 0.11](https://github.com/Zorolefrerot/MATCHLY-PROJECT/actions/runs/34725613010). Extraire **`idrem-zenkai-training-debug.apk`**, pas les journaux.
