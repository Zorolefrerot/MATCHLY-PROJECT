...
**Lot regroupé 0.11 compilé :** village complet de Konoha, quartiers inspirés de la carte fournie, maisons et appartements densifiés en géométrie 3D procédurale, environnement généré limité au ciel, à la terre et à la rivière, PNJ et animaux procéduraux, attaques enrichies d’images/textures, quatorze ultimes monumentales, présence partagée, chat RP/HRP et duel de test à deux joueurs admis. Les comptes et la progression persistante ne changent pas. [Détails du village](../docs/KONOHA_VILLAGE_ENTIER.md) · [Détails des techniques](../docs/ULTIMES_ET_TEXTURES.md).
...
| APK à l’intérieur du ZIP | **71 006 409 octets**, SHA-256 `079cef424e6bfc81d2ef48818d6634f0b525fef93e76f6e0132f8ebe701fd822`, export Android vérifié par le workflow |
| ZIP GitHub | [`idrem-zenkai-android-60`](https://github.com/Zorolefrerot/MATCHLY-PROJECT/actions/runs/34751157241/artifacts/10315533005), **77 248 650 octets**, expiration 20 septembre 2026 à 10:12:38 UTC |
...
Les contrôles utilisent des bases jetables et des profils fictifs. L’artefact est un stockage GitHub temporaire, pas un hébergement permanent ni un DRM. [Contrat et limites](../docs/VILLAGE_PARTAGE.md).

## Historique — résultats du lot regroupé 0.10
