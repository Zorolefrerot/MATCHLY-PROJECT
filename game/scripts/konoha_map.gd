...
const LANDMARKS: Array[Dictionary] = [
	...
	{"name": "Marché", "point": Vector3(-7, 0, 19), "text": "Le marché central rassemble les marchands, les familles et les voyageurs. Les habitants négocient ici leurs achats quotidiens."},
